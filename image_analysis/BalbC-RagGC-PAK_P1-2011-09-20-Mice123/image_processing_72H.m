...
subfolder_struct = dir([mainFolder_path '/' subFolders{7}]);
...
roi_w = 89;
roi_h = 100;
roi1_pos = [95-(roi_w/2), 113, roi_w, roi_h];
roi2_pos = [187-(roi_w/2), 113, roi_w, roi_h];
roi3_pos = [277-(roi_w/2), 113, roi_w, roi_h];
roi4_pos = [371-(roi_w/2), 113, roi_w, roi_h];
