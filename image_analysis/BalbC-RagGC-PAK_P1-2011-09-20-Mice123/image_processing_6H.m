...
roi_w = 89;
roi_h = 120;
roi1_pos = [55-(roi_w/2), 199, roi_w, roi_h];
roi2_pos = [153-(roi_w/2), 199, roi_w, roi_h];
roi3_pos = [248-(roi_w/2), 199, roi_w, roi_h];
roi4_pos = [345-(roi_w/2), 199, roi_w, roi_h];
...
sort_pixel_intens = sort_pixel_intens(~(sort_pixel_intens > 8e2));
