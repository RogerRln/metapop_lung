...
roi_w = 89;
roi_h = 100;
roi1_pos = [120-(roi_w/2), 119, roi_w, roi_h];
roi2_pos = [219-(roi_w/2), 119, roi_w, roi_h];
roi3_pos = [313-(roi_w/2), 119, roi_w, roi_h];
roi4_pos = [404-(roi_w/2), 119, roi_w, roi_h];
...
sort_pixel_intens = sort_pixel_intens(~(sort_pixel_intens > 7e2));
% intensity thresholds
uppp_thresh = 4.5e3;%double(mean(sort_pixel_intens(end-4:end)));
