...
roi_w = 89;
roi_h = 110;
roi1_pos = [74-(roi_w/2), 105, roi_w, roi_h];
roi2_pos = [157-(roi_w/2), 105, roi_w, roi_h];
roi3_pos = [260-(roi_w/2), 105, roi_w, roi_h];
roi4_pos = [349-(roi_w/2), 105, roi_w, roi_h];
...
uppp_thresh = 950;%double(mean(sort_pixel_intens(end-4:end)));
