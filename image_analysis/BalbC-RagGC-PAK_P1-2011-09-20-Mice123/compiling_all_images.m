%% Compile all the image information from the experiment BalbC-RagGC-PAK_P1-2011-09-20-Mice123 in a single data structure
...
set(gcf, 'position', [ 311         220        1687        1088])
% fig_dir =  '/Users/rrodriguez77/Dropbox (GaTech)/images_mice_NIHphage_New_desktop/IVIS_CHM2017_data_fig/figures/';
% saveas(gcf,[fig_dir 'data_RagPpos_2011_09_20_mice123'],'epsc')

%% Save and organize image data

data_RagPpos_2011_09_20_mice123.data = all_data;
data_RagPpos_2011_09_20_mice123.live= [2 3 4];
data_RagPpos_2011_09_20_mice123.dead = [];
data_RagPpos_2011_09_20_mice123.top = top_data;
data_RagPpos_2011_09_20_mice123.bottom = bottom_data;

%save('../data/data_RagPpos_2011_09_20_mice123.mat', 'data_RagPpos_2011_09_20_mice123');
