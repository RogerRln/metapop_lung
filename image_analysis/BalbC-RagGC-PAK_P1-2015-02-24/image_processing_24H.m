...
subfolder_struct = dir([mainFolder_path '/' subFolders{4}]);
...
roi_w = 89;
roi_h = 110;
roi1_pos = [96-(roi_w/2), 35, roi_w, roi_h];
roi2_pos = [178-(roi_w/2), 35, roi_w, roi_h];
roi3_pos = [263-(roi_w/2), 35, roi_w, roi_h];
roi4_pos = [344-(roi_w/2), 35, roi_w, roi_h];
...
border = [(94-34+1) (94-34+1) (100-34+1) (104-34+1) (119-34+1)].*scale;
...
sort_pixel_intens = sort_pixel_intens(~(sort_pixel_intens > 4.3e3));
% intensity thresholds
uppp_thresh = 4.3e3;%double(mean(sort_pixel_intens(end-5:end)));
