...
roi_w = 89;
roi_h = 100;
roi1_pos = [93-(roi_w/2), 113, roi_w, roi_h];
roi2_pos = [183-(roi_w/2), 113, roi_w, roi_h];
roi3_pos = [278-(roi_w/2), 113, roi_w, roi_h];
roi4_pos = [373-(roi_w/2), 113, roi_w, roi_h];
...
sort_pixel_intens = sort_pixel_intens(~(sort_pixel_intens > 1.5e3));
% intensity thresholds
uppp_thresh = double(mean(sort_pixel_intens(end-8:end)));
