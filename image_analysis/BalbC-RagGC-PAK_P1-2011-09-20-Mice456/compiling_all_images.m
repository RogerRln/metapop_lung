%% Compile all the image information from the experiment BalbC-RagGC-PAK_P1-2011-09-20-Mice456 in a single data structure
...
% saveas(gcf,[fig_dir 'data_RagPpos_2011_09_20_mice456'],'epsc')

%% Save and organize image data

data_RagPpos_2011_09_20_mice456.data = all_data;
data_RagPpos_2011_09_20_mice456.live= [2 3 4];
data_RagPpos_2011_09_20_mice456.dead = [];
data_RagPpos_2011_09_20_mice456.top = top_data;
data_RagPpos_2011_09_20_mice456.bottom = bottom_data;

% save('../data/data_RagPpos_2011_09_20_mice456.mat', 'data_RagPpos_2011_09_20_mice456');
