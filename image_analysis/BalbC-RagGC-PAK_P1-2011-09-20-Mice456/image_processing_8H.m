...
roi_w = 89;
roi_h = 125;
roi1_pos = [75-(roi_w/2), 131, roi_w, roi_h];
roi2_pos = [168-(roi_w/2), 131, roi_w, roi_h];
roi3_pos = [262-(roi_w/2), 131, roi_w, roi_h];
roi4_pos = [352-(roi_w/2), 131, roi_w, roi_h];
...
uppp_thresh = 750;%double(mean(sort_pixel_intens(end-4:end)));
