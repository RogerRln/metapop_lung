...
roi_w = 89;
roi_h = 120;
roi1_pos = [76-(roi_w/2), 113, roi_w, roi_h];
roi2_pos = [159-(roi_w/2), 113, roi_w, roi_h];
roi3_pos = [258-(roi_w/2), 113, roi_w, roi_h];
roi4_pos = [349-(roi_w/2), 113, roi_w, roi_h];
...
uppp_thresh = 900;%double(mean(sort_pixel_intens(end-4:end)));
