...
roi_w = 89;
roi_h = 100;
roi1_pos = [119-(roi_w/2), 115, roi_w, roi_h];
roi2_pos = [216-(roi_w/2), 115, roi_w, roi_h];
roi3_pos = [307-(roi_w/2), 115, roi_w, roi_h];
roi4_pos = [405-(roi_w/2), 115, roi_w, roi_h];
...
sort_pixel_intens = sort_pixel_intens(~(sort_pixel_intens > 2.2e4));
% intensity thresholds
uppp_thresh = double(mean(sort_pixel_intens(end-4:end)));
