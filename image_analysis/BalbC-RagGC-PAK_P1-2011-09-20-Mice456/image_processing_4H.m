...
roi_w = 89;
roi_h = 120;
roi1_pos = [55-(roi_w/2), 157, roi_w, roi_h];
roi2_pos = [150-(roi_w/2), 157, roi_w, roi_h];
roi3_pos = [243-(roi_w/2), 157, roi_w, roi_h];
roi4_pos = [339-(roi_w/2), 157, roi_w, roi_h];
