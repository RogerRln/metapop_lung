...
roi_w = 89;
roi_h = 125;
roi1_pos = [107-(roi_w/2), 90, roi_w, roi_h];
roi2_pos = [205-(roi_w/2), 90, roi_w, roi_h];
roi3_pos = [299-(roi_w/2), 90, roi_w, roi_h];
roi4_pos = [394-(roi_w/2), 90, roi_w, roi_h];
