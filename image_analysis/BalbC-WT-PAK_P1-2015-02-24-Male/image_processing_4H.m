...
roi_w = 89;
roi_h = 100;
roi1_pos = [94-(roi_w/2), 40, roi_w, roi_h];
roi2_pos = [176-(roi_w/2), 40, roi_w, roi_h];
roi3_pos = [262-(roi_w/2), 40, roi_w, roi_h];
...
uppp_thresh = 1.1e3;%double(mean(sort_pixel_intens(end-20:end)));
