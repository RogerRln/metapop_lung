...
roi_w = 89;
roi_h = 100;
roi1_pos = [100-(roi_w/2), 79, roi_w, roi_h];
roi2_pos = [186-(roi_w/2), 79, roi_w, roi_h];
roi3_pos = [269-(roi_w/2), 79, roi_w, roi_h];
...
uppp_thresh = 9.3e2;%double(mean(sort_pixel_intens(end-20:end)));
