%% Compile all the image information from the experiment BalbC-WT-PAK_P1-2015-02-24-Male in a single data structure
...
% saveas(gcf,[fig_dir 'data_IposPpos_2015_02_24_male'],'epsc')

%% Save and organize image data

data_IposPpos_2015_02_24_male.data = all_data;
data_IposPpos_2015_02_24_male.live= [2 3];
data_IposPpos_2015_02_24_male.dead = [ ];
data_IposPpos_2015_02_24_male.top =  top_data;
data_IposPpos_2015_02_24_male.bottom = bottom_data;

% save('../data/data_IposPpos_2015_02_24_male.mat', 'data_IposPpos_2015_02_24_male');
