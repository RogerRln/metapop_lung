...
roi_w = 89;
roi_h = 100;
roi1_pos = [108-(roi_w/2), 40, roi_w, roi_h];
roi2_pos = [181-(roi_w/2), 40, roi_w, roi_h];
roi3_pos = [270-(roi_w/2), 40, roi_w, roi_h];
...
uppp_thresh = 1.05e3;%double(mean(sort_pixel_intens(end-20:end)));
low_thresh = avg_intensity+30;
