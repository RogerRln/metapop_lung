...
roi_w = 89;
roi_h = 100;
roi1_pos = [96-(roi_w/2), 48, roi_w, roi_h];
roi2_pos = [177-(roi_w/2), 48, roi_w, roi_h];
roi3_pos = [264-(roi_w/2), 48, roi_w, roi_h];
...
uppp_thresh = 1.2e3;%double(mean(sort_pixel_intens(end-20:end)));
