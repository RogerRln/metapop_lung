...
roi_w = 89;
roi_h = 100;
roi1_pos = [101-(roi_w/2), 67, roi_w, roi_h];
roi2_pos = [188-(roi_w/2), 67, roi_w, roi_h];
roi3_pos = [271-(roi_w/2), 67, roi_w, roi_h];
...
uppp_thresh = 9e2;%double(mean(sort_pixel_intens(end-20:end)));
