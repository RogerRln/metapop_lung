%% Compile all the image information from the experiment BalbC-WT-PAK_P1-2015-02-24-Female in a single data structure
% In the experiment WT immunocompetent mice were treated with phage
...
set(gcf, 'position', [303         367        1908         941])
% fig_dir =  '/Users/rrodriguez77/Dropbox (GaTech)/images_mice_NIHphage_New_desktop/IVIS_CHM2017_data_fig/figures/';
% saveas(gcf,[fig_dir 'data_IposPpos_2015_02_24_female'],'epsc')

%% Save and organize image data

data_IposPpos_2015_02_24_female.data = all_data;
data_IposPpos_2015_02_24_female.live= [2 3];
data_IposPpos_2015_02_24_female.dead = [ ];
data_IposPpos_2015_02_24_female.top = top_data;
data_IposPpos_2015_02_24_female.bottom = bottom_data;

% save('../data/data_IposPpos_2015_02_24_female.mat', 'data_IposPpos_2015_02_24_female');
