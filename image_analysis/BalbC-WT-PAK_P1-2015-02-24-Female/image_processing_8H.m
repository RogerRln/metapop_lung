...
roi_w = 89;
roi_h = 95;
roi1_pos = [105-(roi_w/2), 40, roi_w, roi_h];
roi2_pos = [181-(roi_w/2), 40, roi_w, roi_h];
roi3_pos = [269-(roi_w/2), 40, roi_w, roi_h];
...
sort_pixel_intens = sort_pixel_intens(~(sort_pixel_intens > 1.05e3));
% intensity thresholds
uppp_thresh = double(mean(sort_pixel_intens(end-6:end)));
