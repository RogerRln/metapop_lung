...
roi_w = 89;
roi_h = 100;
roi1_pos = [100-(roi_w/2), 82, roi_w, roi_h];
roi2_pos = [182-(roi_w/2), 82, roi_w, roi_h];
roi3_pos = [269-(roi_w/2), 82, roi_w, roi_h];
...
sort_pixel_intens = sort_pixel_intens(~(sort_pixel_intens > 2.5e3));
% intensity thresholds
uppp_thresh = 9.5e2;%double(mean(sort_pixel_intens(end-6:end)));
