...
mice_num = regexp(mice_number, 'B.+?\-(\d).(\d)', 'tokens');
...
roi_w = 89;
roi_h = 100;
roi1_pos = [96-(roi_w/2), 47, roi_w, roi_h];
roi2_pos = [177-(roi_w/2), 47, roi_w, roi_h];
roi3_pos = [264-(roi_w/2), 47, roi_w, roi_h];
