...
roi_w = 89;
roi_h = 100;
roi1_pos = [99-(roi_w/2), 67, roi_w, roi_h];
roi2_pos = [185-(roi_w/2), 67, roi_w, roi_h];
roi3_pos = [269-(roi_w/2), 67, roi_w, roi_h];
...
uppp_thresh = 9.1e2;%double(mean(sort_pixel_intens(end-6:end)));
