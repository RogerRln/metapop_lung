%% Function to simulate the metapopulation model for different immune and phage conditions
...
function [time, res, p] = simu_metapop(B, P, I, max_neutrophil_num, b_dist, p_dist, simu_time)
