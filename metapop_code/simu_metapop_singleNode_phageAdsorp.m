%% Function to simulate the well-mixed model given different immune levels and phage adsorption rates
...
function [time, res, p] = simu_metapop_singleNode_phageAdsorp(B, P, I, max_neutrophil_num, phi_value, simu_time)
