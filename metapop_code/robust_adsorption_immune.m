%% Function to simulate the metapopulation model given changes in the phage adsorption rate and neutrophil counts
...
%         (6) adsorption - phage adsorption rate 
%         (7) inocuDist_params - matrix of size 84 x 4 with bacteria and phage network
%         distribution parameters

% output: (1)Total_CFU_params - vector of size 84 x 1, with total cfu after
%         250 h after simulating 84 diff. initial conditions
%         (2)Time_extinct_vec - vector of size 84 x 1, with the time to
%         infection resolution after simulating 84 diff. initial conditions
%         (3)p - structure variable with parameter values

function [Total_CFU_params, Time_extinct_vec, p] = robust_adsorption_immune(B, P, I, max_neutrophil_num, simu_time, adsorption, inocuDist_params)
